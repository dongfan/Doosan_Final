...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        # Node(
        #     package='dsr_example',
        #     executable='llm_motion_planner',
        #     name='llm_motion_planner',
        #     output='screen'
        # ),
        # Node(
        #     package='dsr_example',
        #     executable='motion_controller_executor',
        #     name='motion_controller_executor',
        #     output='screen'
        # ),
        Node(
            package='dsr_example',
        ...
        # Node(
        #     package='dsr_example',
        #     executable='llm_reasoner_node',
        #     name='llm_reasoner_node',
        #     output='screen'
        # ),
        # Node(
        #     package='dsr_example',
